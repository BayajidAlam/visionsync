    ...
    <div className="yt-shell min-h-screen">
            ...
            >
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-muted-foreground">
                  Build your own stream identity
                </p>
              </div>
            </button>
      ...
      <div className="mx-auto flex w-full max-w-[1600px] gap-4 px-3 pb-28 pt-4 sm:px-6 md:pb-12">
        <aside className="yt-sidebar hidden shrink-0 md:block md:w-20 lg:w-64">
          ...
          <div className="yt-surface mt-4 hidden p-4 lg:block">
            <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">
              Creator Notes
            </p>
            <div className="mt-3 space-y-2 text-sm text-muted-foreground">
              <p>Home is for browsing and playback.</p>
              <p>Studio is where you upload and manage work.</p>
              <p>Use quick chips to narrow results by status.</p>
            </div>
          </div>
        </aside>

        <main className="min-w-0 flex-1 space-y-6">
          <section className="feed-enter rounded-3xl border border-primary/20 bg-gradient-to-r from-slate-950 via-slate-900 to-indigo-900 p-6 text-white shadow-xl shadow-slate-950/30 dark:from-slate-900 dark:via-slate-800 dark:to-slate-700">
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <h1 className="mt-2 text-3xl font-bold leading-tight sm:text-4xl">
                  Your videos, your style, all in one place
                </h1>
                <p className="mt-3 max-w-2xl text-sm text-white/80">
                  Browse what is ready, check what is still processing, and jump
                  into Studio whenever you want to upload new videos.
                </p>
              </div>
            </div>
          </section>
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
            ...
            <span>Search: {hasSearch ? `"${debouncedSearch}"` : "None"}</span>
      ...
      <footer className="w-full pb-0 pt-2">
        <div className="yt-footer-panel">
          <div className="yt-footer-inner">
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm text-white/80">
                  Use Home to browse and watch, then switch to Studio whenever
                  you are ready to upload your next video.
                </p>
              </div>
            </div>
            ...
            <div className="mt-5 grid gap-3 text-sm text-white/80 sm:grid-cols-3">
              <div className="rounded-xl border border-white/20 bg-white/10 px-3 py-2 backdrop-blur">
                Watch videos on Home
              </div>
              <div className="rounded-xl border border-white/20 bg-white/10 px-3 py-2 backdrop-blur">
                Upload and manage in Studio
              </div>
              <div className="rounded-xl border border-white/20 bg-white/10 px-3 py-2 backdrop-blur">
                Switch light or dark anytime
              </div>
            </div>
          </div>
        </div>
